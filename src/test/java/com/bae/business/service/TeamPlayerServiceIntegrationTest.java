...
public class TeamPlayerServiceIntegrationTest {
	...
	@Before
	public void init() {
		this.testTeamPlayer = new TeamPlayer("Spongebob", "Squarepants");
	...
	public void testDeletePlayer() {
		assertThat(this.service.deletePlayer(this.testTeamPlayerWithID.getId())).isFalse();
	}
	
	@Test
	public void testFindPlayerByID() {
		assertEquals(this.service.findPlayerByID(this.testTeamPlayerWithID.getId()).toString(), this.testTeamPlayerWithID.toString());
	}

	@Test
	public void testGetAllTeamPlayer() {
		assertThat(this.service.getAllPlayer().toString()).isEqualTo(Arrays.asList(new TeamPlayer[] {this.testTeamPlayerWithID }).toString());
	}

	@Test
	public void testUpdateTeamPlayer() {
		TeamPlayer newTeamPlayer = new TeamPlayer("Dora", "Explorer");
		...
		assertThat(this.service.updatePlayer(newTeamPlayer, this.testTeamPlayerWithID.getId()).toString()).isEqualTo(updatedTeamPlayer.toString());
	}
